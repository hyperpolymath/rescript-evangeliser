...
:experimental:
:url-github: https://github.com/hyperpolymath/rescript-evangeliser
:url-gitlab: https://gitlab.com/hyperpolymath/rescript-evangeliser
:url-bitbucket: https://bitbucket.org/hyperpolymath/rescript-evangeliser
:url-codeberg: https://codeberg.org/hyperpolymath/rescript-evangeliser

ReScript adoption and evangelism toolkit
...
rescript-evangeliser is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
